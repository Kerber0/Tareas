...
FOREIGN KEY (nReservs REFERENCES reservas (nReserva)
);
...
/*2.3*/
ALTER TABLE camareros MODIFY turno SET ("mañana", "tarde", "noche");

/*2.4*/
ALTER TABLE proveedores ADD apellidos CHAR(40) NOT NULL AFTER codigoPro;
ALTER TABLE proveedores ADD nombre CHAR(40) NOT NULL AFTER codigoPro;

/*2.5*/
ALTER TABLE mesas MODIFY nAsientos DEFAULT (4);

/*2.6*/
ALTER TABLE productos ADD INDEX i_categoria (categoria);
ALTER TABLE productos MODIFY stock INT(4) UNSIGNED NOT NULL;
ALTER TABLE productos DROP INDEX i_categoria;
